...
spotcheckModule.factory('SpotcheckMismatchTrackingAPI', ['$resource', function($resource){
    return $resource(adminApiPath + "/spotcheck/:refType/mismatch/:mismatchId/issue/:issueId", {
        mismatchId: '@mismatchId',
        issueId: '@issueId',
        refType: '@refType'
    });
...
spotcheckModule.directive('mismatchDiff', ['$timeout', function($timeout){
    return {
        ...
        template: "<span ng-class='{preformatted: pre, \"word-wrap\": !pre}' style='line-height: {{lineHeight}}px'>" +
...
spotcheckModule.directive('diffSummary', function(){
    return {
        ...
        template: "<div ng-repeat='diff in selectedDiffs'>" +
